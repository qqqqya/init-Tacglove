...
#ifndef COMMON_MSGS__MSG__DETAIL__KEY_STATE__TYPE_SUPPORT_H_
#define COMMON_MSGS__MSG__DETAIL__KEY_STATE__TYPE_SUPPORT_H_
...
#endif  // COMMON_MSGS__MSG__DETAIL__KEY_STATE__TYPE_SUPPORT_H_
