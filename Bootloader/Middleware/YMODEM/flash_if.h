...
#define SN_LENGTH        FIRMWARE_SN_LENGTH_BYTES
#define SN_PREFIX        FIRMWARE_SN_PREFIX
#define SN_PREFIX_LENGTH FIRMWARE_SN_PREFIX_LENGTH_BYTES
#define SN_VALID_FLAG    FIRMWARE_SN_VALID_FLAG
